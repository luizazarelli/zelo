...
function UserAvatar({ photo, onPick }) {
  ...
  return (
    <div style={av.wrap} onClick={() => inputRef.current.click()}>
      {photo
        ? <img src={photo} style={av.img} alt="foto de perfil" />
        : <div style={av.circle}>
      ...
      <div style={av.badge}>
        <svg width="16" height="16" viewBox="0 0 24 24" fill="#fff">
          <path d="M12 15.5A3.5 3.5 0 0 1 8.5 12 3.5 3.5 0 0 1 12 8.5a3.5 3.5 0 0 1 3.5 3.5 3.5 3.5 0 0 1-3.5 3.5m7-10h-2.17l-1.24-1.35A2 2 0 0 0 14.12 3H9.88c-.56 0-1.1.24-1.47.65L7.17 5H5C3.9 5 3 5.9 3 7v12a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V7c0-1.1-.9-2-2-2z" />
        </svg>
      </div>
...
const av = {
  wrap: {
    position: 'relative', width: 167, height: 167,
