...
import { AddWorkerServiceTypeInputDto } from "./add-worker-service-type.input.dto";

@injectable()
export class AddWorkerServiceTypeUseCase
	implements BaseUsecase<AddWorkerServiceTypeInputDto, void>
{
	constructor(
	...
	async execute(payload: AddWorkerServiceTypeInputDto): Promise<void> {
