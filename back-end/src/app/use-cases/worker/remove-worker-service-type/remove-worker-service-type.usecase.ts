...
import type { RemoveWorkerServiceTypeInputDto } from "./remove-worker-service-type.input.dto";

@injectable()
export class RemoveWorkerServiceTypeUseCase
	implements BaseUsecase<RemoveWorkerServiceTypeInputDto, void>
{
	constructor(
	...
	async execute({
		serviceTypeId,
		workerId,
	}: RemoveWorkerServiceTypeInputDto): Promise<void> {
